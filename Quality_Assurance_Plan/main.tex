	...
	\begin{table}[h]
		\noindent\makebox[\textwidth]{
			\begin{tabularx}{1.2\textwidth}{l|l|w|n|n}
				...
				1.1 & 2020-11-07 &	Document Review Process added (ch 6) & Emma Johansson & Patrik Palmgren \\
				\bottomrule
			\end{tabularx}
		}
