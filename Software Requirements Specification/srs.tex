...
\begin{center}
\begin{tabularx}{\linewidth}{|p{1,8cm}|p{1,4cm}|p{4.6cm}|p{2.5cm}|p{2.5cm}|}
 \hline
 ...
 \hline
 2020-12-10 & 2.8 & Moved back implemented requirements from section 3.6 and moved unimplemented requirements to section 3.6 according to feedback from development & Sara Lindholm & \\
 \hline 
\end{tabularx}
\end{center}
...
FR025 fulfilled &
    \textbf{Input}: The list of patients have been sorted. 
    \newline \textbf{Action}: Load sorting parameter 
    \newline \textbf{Output}: Display sorting parameter & 
Low \\ 
\hline
\end{tabularx}
\end{center}
