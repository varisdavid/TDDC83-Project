...
\item Ensure consistency in how HCU terms are used: Operation, department, subdepartment and team
\end{enumerate}
...
Right now RE only looks at most recent value.
Statistics, ML to classify. Modular --> can be implemented.
\subsubsection{Calendars}
\subsubsection{Prioritization}\label{future-prioritization}
Dynamic rule engine - prioritizing among many patients
